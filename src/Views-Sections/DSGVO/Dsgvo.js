...
import styles from "../DSGVO/dsgvo.module.scss";

const Dsgvo = () => {
  return (
    <div className={styles["dsgvo-page-container"]}>
      <div className={styles["content-container"]}>
        <h4 className={styles["main-headings"]}>Privacy Policy</h4>
        <p className={styles["paragraphs"]}>
          We are very delighted that you have shown interest in our enterprise.
          Data protection is of a particularly high priority for the management
          of the Dresden Psych Family e.V.. The use of the Internet pages of the
          Dresden Psych Family e.V. is possible without any indication of
        ...
        <p className={styles["paragraphs"]}>
          ...
          the Dresden Psych Family e.V.. By means of this data protection
        ...
        <p className={styles["paragraphs"]}>
          As the controller, the Dresden Psych Family e.V. has implemented
        ...
        <h5 className={styles["sub-headings"]}>1. Definitions</h5>
        <p className={styles["paragraphs"]}>
          The data protection declaration of the Dresden Psych Family e.V. is
        ...
        <ul className={styles["list"]}>
          <li>
            <span className={styles["list-headings"]}>a) Personal data:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>b) Data subject:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>c) Processing:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>e) Profiling:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>h) Processor:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>i) Recipient:</span>
            <p className={styles["paragraphs"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>j) Third party:</span>
            <p className={styles["paragraphs"]}>
              Recipient is a natural or legal person, public authority, agency
              or another body, to which the personal data are disclosed, whether
              a third party or not. However, public authorities which may
          ...
          <li>
            <span className={styles["list-headings"]}>k) Consent:</span>
            <p className={styles["paragraphs"]}>
        ...
        <span className={styles["spans"]}>Dresden Psych Family e.V.</span>
        <span className={styles["spans"]}>Sternstraße 35</span>
        <span className={styles["spans"]}>01139 Dresden</span>
        <span className={styles["spans"]}>Germany</span>
        <span className={styles["spans"]}>
          Phone:{" "}
          <a
        ...
        <span className={styles["spans"]}>
          Website: www.reverberationfest.de
        </span>
        <h5 className={styles["sub-headings"]}>
          3. Collection of general data and information
        </h5>
        <p className={styles["paragraphs"]}>
          The website of the Dresden Psych Family e.V. collects a series of
        ...
        <p className={styles["paragraphs"]}>
          When using these general data and information, the Dresden Psych
          Family e.V. does not draw any conclusions about the data subject.
          ...
          criminal prosecution in case of a cyber-attack. Therefore, the Dresden
          Psych Family e.V. analyzes anonymously collected data and information
        ...
        <ul className={styles["list"]}>
          ...
          <li>
            <span className={styles["list-headings"]}>b) Right of access:</span>
            <p className={styles["paragraphs"]}>
              Each data subject shall have the right granted by the European
          ...
          <li>
            <p className={styles["paragraphs"]}>
              ...
              Dresden Psych Family e.V., he or she may, at any time, contact any
              employee of the controller. An employee of Dresden Psych Family
              e.V. shall promptly ensure that the erasure request is complied
              ...
              required. An employees of the Dresden Psych Family e.V. will
          ...
          <li>
            <p className={styles["paragraphs"]}>
              ...
              data stored by the Dresden Psych Family e.V., he or she may at any
              time contact any employee of the controller. The employee of the
              Dresden Psych Family e.V. will arrange the restriction of the
              processing.
            </p>
          </li>
          ...
          <li>
            ...
            <p className={styles["paragraphs"]}>
              ...
              official authority vested in the controller. Furthermore, in
            ...
            <p className={styles["paragraphs"]}>
              ...
              may at any time contact any employee of the Dresden Psych Family
              e.V..
            </p>
          </li>

          <li>
            <span className={styles["list-headings"]}>g) Right to object:</span>
            <p className={styles["paragraphs"]}>
              Each data subject shall have the right granted by the European
            ...
            <p className={styles["paragraphs"]}>
              The Dresden Psych Family e.V. shall no longer process the personal
            ...
            <p className={styles["paragraphs"]}>
              If the Dresden Psych Family e.V. processes personal data for
              ...
              subject objects to the Dresden Psych Family e.V. to the processing
              for direct marketing purposes, the Dresden Psych Family e.V. will
            ...
            <p className={styles["paragraphs"]}>
              ...
              personal data concerning him or her by the Dresden Psych Family
              e.V. for scientific or historical research purposes, or for
            ...
            <p className={styles["paragraphs"]}>
              ...
              contact any employee of the Dresden Psych Family e.V.. In
          ...
          <li>
            ...
            <p className={styles["paragraphs"]}>
              ...
              consent, the Dresden Psych Family e.V. shall implement suitable
              ...
              point of view and contest the decision. If the data subject wishes
              to exercise the rights concerning automated individual
              decision-making, he or she may, at any time, contact any employee
              of the Dresden Psych Family e.V..
            </p>
          </li>
          ...
          <li>
            ...
            <p className={styles["paragraphs"]}>
              ...
              her personal data at any time. If the data subject wishes to
              exercise the right to withdraw the consent, he or she may, at any
              time, contact any employee of the Dresden Psych Family e.V..
            </p>
          </li>
        </ul>
        <h5 className={styles["sub-headings"]}>
          6. Data protection provisions about the application and use of
          Facebook
        </h5>
        <p className={styles["paragraphs"]}>
        ...
        <p className={styles["paragraphs"]}>
          ...
          with the personal Facebook user account of the data subject and stores
          the personal data.
        </p>
        <p className={styles["paragraphs"]}>
          ...
          subject is logged in at the same time on Facebook during the time of
        ...
        <p className={styles["paragraphs"]}>
          ...
          In addition, it is explained there what setting options Facebook
          offers to protect the privacy of the data subject. In addition,
          different configuration options are made available to allow the
          elimination of data transmission to Facebook. These applications may
          be used by the data subject to eliminate a data transmission to
          Facebook.
        </p>
        <h5 className={styles["sub-headings"]}>
        ...
        <p className={styles["paragraphs"]}>
          ...
          logging off from their Instagram account before a call-up to our
          website is made.
        </p>
        <p className={styles["paragraphs"]}>
        ...
        <p className={styles["paragraphs"]}>
          ...
          <a
            ...
            alt="Link to GDPR time tracker website"
            target="_blank"
            rel="noopener noreferrer"
          >
            GDPR time tracker
          ...
          provided and published by{" "}
          <a
            className={styles["anchor-tags"]}
            href="https://dg-datenschutz.de/"
            alt="Link to dg-datenschutz website"
            target="_blank"
            rel="noopener noreferrer"
          >
